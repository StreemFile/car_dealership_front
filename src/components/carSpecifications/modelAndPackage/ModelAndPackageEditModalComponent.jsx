...
const ModelAndPackageEditModalComponent = (props) => {
    const [name, setName] = useState(props.object.model);
    const [pack, setPack] = useState(props.object.pack);
    const [description, setDescription] = useState(props.object.description);

    useEffect(() => {
        setName(props.object.model);
        setPack(props.object.pack)
...
export default ModelAndPackageEditModalComponent;